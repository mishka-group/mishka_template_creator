...
function createSectionOnSortableJS(htmlElement) {
  ...
  <div class="flex flex-row justify-start items-center space-x-3 absolute -left-[2px] -top-11 bg-gray-200 border border-gray-200 p-2 rounded-tr-3xl z-10 w-52" phx-click="test-btn" phx-value-type=${htmlElement.dataset.type}>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-red-600 cursor-pointer">
