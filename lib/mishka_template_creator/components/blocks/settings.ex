defmodule MishkaTemplateCreator.Components.Blocks.Settings do
  ...
  @tailwind_settings [
    ...
    {"effects", "Effects", "Heroicons.light_bulb",
     [
       {"box-shadow", "Box Shadow", "Utilities for controlling the box shadow of an element.",
        [
          "shadow-sm",
          "shadow",
          "shadow-md",
       ...
       {"opacity", "Opacity", "Utilities for controlling the opacity of an element.",
        [
          "opacity-0",
          "opacity-5",
          "opacity-10",
    ...
    {"filters", "Filters", "Heroicons.scissors",
     [
       {"blur", "Blur", "Utilities for applying blur filters to an element.",
        [
          "blur-none",
          "blur-sm",
          "blur",
       ...
       {"brightness", "Brightness", "Utilities for applying brightness filters to an element.",
        [
          "brightness-0",
          "brightness-50",
          "brightness-75",
       ...
       {"contrast", "Contrast", "Utilities for applying brightness filters to an element.",
        [
          "contrast-0",
          "contrast-50",
          "contrast-75",
       ...
       {"drop-shadow", "Drop Shadow", "Utilities for applying drop-shadow filters to an element.",
        [
          "drop-shadow-sm",
          "drop-shadow",
          "drop-shadow-md",
       ...
       {"grayscale", "Grayscale", "Utilities for applying grayscale filters to an element.",
        [
          "grayscale-0",
          "grayscale"
        ], [:hover, :media_queries]},
       {"hue-rotate", "Hue Rotate", "Utilities for applying drop-shadow filters to an element.",
        [
          "hue-rotate-0",
          "hue-rotate-15",
          "hue-rotate-30",
       ...
       {"invert", "Invert", "Utilities for applying invert filters to an element.",
        [
          "invert-0",
          "invert"
        ], [:hover, :media_queries]},
       {"saturate", "Saturate", "Utilities for applying saturation filters to an element.",
        [
          "saturate-0",
          "saturate-50",
          "saturate-100",
       ...
       {"sepia", "Sepia", "Utilities for applying sepia filters to an element.",
        [
          "sepia-0",
          "sepia"
        ], [:hover, :media_queries]},
       ...
       {"backdrop-sepia", "Backdrop Sepiae",
    ...
    {"tables", "Tables", "Heroicons.table_cells",
     [
       ...
       {"table-layout", "Table Layout", "Utilities for controlling the table layout algorithm.",
        [
          "table-auto",
          "table-fixed"
        ], [:hover, :media_queries]}
    ...
    {"scale", "Scale", "Heroicons.rectangle_stack",
     [
       {"animation", "Animation", "Utilities for scaling elements with transform.",
        [
          "scale-0",
          "scale-x-0",
          "scale-y-0",
       ...
       {"rotate", "Rotate", "Utilities for rotating elements with transform.",
        [
          "rotate-0",
          "rotate-1",
          "rotate-2",
       ...
       {"translate", "Translate", "Utilities for rotating elements with transform.",
        [
          "translate-x-0",
          "translate-y-0",
          "translate-x-px",
       ...
       {"skew", "Skew", "Utilities for skewing elements with transform.",
        [
          "skew-x-0",
          "skew-y-0",
          "skew-x-1",
    ...
    {"interactivity", "Interactivity", "Heroicons.paper_clip",
     [
       ...
       {"appearance", "Appearance", "Utilities for suppressing native form control styling.",
        [
          "appearance-none"
        ], [:hover, :media_queries]},
       {"cursor", "Cursor",
       ...
       {"resize", "Resize", "Utilities for controlling how an element can be resized.",
        [
          "resize-none",
          "resize-y",
          "resize-x",
    ...
    {"svg", "SVG", "Heroicons.photo",
     [
       {"fill", "Fill", "Utilities for styling the fill of SVG elements.",
        [
          "fill-none",
          "fill-inherit",
          "fill-current",
       ...
       {"stroke", "Stroke", "Utilities for styling the stroke of SVG elements.",
        [
          "stroke-none",
          "stroke-inherit",
          "stroke-current",
       ...
       {"stroke-width", "Stroke Width", "Utilities for styling the stroke width of SVG elements.",
        [
          "stroke-0",
          "stroke-1",
          "stroke-2"
